...
#[allow(unused)]
pub fn foreach_section_buffer<T: Fn(&mut Vec<u8>, IMAGE_SECTION_HEADER) -> bool>(buffer: &mut Vec<u8>, dos: IMAGE_DOS_HEADER, nts: IMAGE_NT_HEADERS64, cb: T) -> Result<_, _>
{
